...
(function () {
  ...
  const PRODUCTS = {
    ...
    usda: {
      key: "usda",
      name: "USDA",
      blurb: "0% down in eligible rural areas.",
      downOptions: [0],
      defaultDown: 0,
      upfrontFeePct: 0.01,     // upfront guarantee fee, financed
      financeUpfront: true,
      pmiRate: function () { return 0; },
      annualMIPct: 0.0035,     // annual guarantee fee
      miCancelLTV: null,
      footnotes: function () {
        return ["Upfront guarantee fee of 1% is financed into the loan.",
                "Annual fee \u2248 0.35% is included in the payment.",
                "Property must be in a USDA-eligible area and within income limits."];
      }
    }
  };
